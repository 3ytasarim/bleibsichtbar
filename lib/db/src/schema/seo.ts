...
export const seoTable = pgTable("seo_settings", {
  ...
  metaTitleNl: text("meta_title_nl").notNull().default(""),
  metaDescriptionNl: text("meta_description_nl").notNull().default(""),
  metaTitleFr: text("meta_title_fr").notNull().default(""),
  metaDescriptionFr: text("meta_description_fr").notNull().default(""),
