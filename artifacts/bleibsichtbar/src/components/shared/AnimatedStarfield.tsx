...
export function AnimatedStarfield({ color = "#ff6b35", className }: AnimatedStarfieldProps) {
  ...
  useEffect(() => {
    ...
    const initThree = (THREE: any) => {
      ...
      const handleResize = () => {
        ...
        uniforms.u_resolution.value.set(canvasRef.current.clientWidth * 2, canvasRef.current.clientHeight * 2);
      };
