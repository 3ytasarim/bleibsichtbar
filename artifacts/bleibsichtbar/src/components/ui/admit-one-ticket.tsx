// Vendored from the 21st.dev registry (larsen66/admit-one-ticket) verbatim —
// a self-contained WebGL/canvas dithering-shader "admission ticket" visual.
// Left untyped on purpose: it's copied for its runtime behavior, not hand-
// maintained, and hand-annotating 250+ raw WebGL/canvas call sites would add
// no real safety for code that never changes.
// @ts-nocheck
